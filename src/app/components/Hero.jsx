...
export default function DemoPage() {
  ...
  // Optimized animation variant for "butter" smoothness
  const fadeInUp = {
  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full transform-gpu">
        ...
        <section className="relative pt-32 pb-16 md:pb-20 px-6">
          ...
          >
            <div className="inline-block px-4 py-1.5 mb-6 border border-green-800/20 rounded-full bg-green-50 shadow-sm">
            ...
            <h1 className="text-5xl text-black sm:text-7xl md:text-[120px] leading-[1] md:leading-[0.85] serif mb-8 tracking-tight">
            ...
            {/* --- ADDED LINK TO VISION --- */}
            <Link href="/Collection">
              <button className="w-full sm:w-auto px-10 py-4 bg-green-900 text-white rounded-full font-bold tracking-widest text-xs uppercase hover:bg-green-800 transition-all shadow-xl shadow-green-900/20 transform hover:-translate-y-1 active:scale-95">
                Start Shopping
              </button>
            </Link>
          </motion.div>
        ...
        <section className="min-h-[70vh] md:h-[80vh] rounded-t-[2rem] md:rounded-t-3xl flex bg-gradient-to-r from-[#133026] to-[#174032] items-center p-6 md:p-3 relative overflow-hidden">
          <motion.div 
            initial={{ opacity: 0, scale: 0.98 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
            className="w-full md:w-[60vw] max-w-7xl mx-auto flex flex-col items-center text-center relative z-10"
          >
            ...
            <div className="relative py-8 md:py-10 px-6 md:px-12 border-y border-white/10 w-full max-w-4xl backdrop-blur-sm bg-white/5 rounded-2xl">
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 py-16 md:py-20 bg-white gap-12 lg:gap-0">
          ...
          >
            ...
            <div className="pt-4">
              <Link prefetch={true} href="#"> 
                <button className="w-full sm:w-auto bg-green-900 text-white py-4 px-10 rounded-full text-xs font-bold uppercase tracking-[0.2em] hover:bg-green-800 transition-all shadow-xl shadow-green-900/20 active:scale-95 transform hover:scale-105">
                  Explore Vision
                </button>
              </Link>
            </div>
          ...
          >
            <div className="relative group w-full max-w-[500px] lg:max-w-none">
              <div className="absolute -inset-4 bg-green-100/50 rounded-[3rem] blur-3xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
